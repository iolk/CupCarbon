...
public class ScriptFunctions {
	...
	public static String[] function(String function, String[] args) {
		...
		if (function.equals("kafkaProduce")) {
			return new String[] { Functions.kafkaProduce(args), "0.0", "0.0" };
		}

		if (function.equals("kafkaConsume")) {
			return new String[] { Functions.kafkaConsume(args), "0.0", "0.0" };
		}

		if (function.equals("concatenate")) {
